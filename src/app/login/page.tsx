    ...
    <main className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="w-full max-w-[380px]">
        <div className="rounded-[18px] border border-line bg-paper p-6 shadow-sm">
          <div className="mb-5">
            <div className="text-[20px] font-extrabold tracking-[-0.01em] text-ink">Sign in</div>
            <div className="mt-1 text-[13px] text-muted">Enter the email and password your organization set up for you.</div>
          </div>
        ...
        <p className="mt-4 text-center text-[11.5px] text-muted">Accounts are created by your organization, not self-service.</p>
      </div>
    </main>
  );
}
