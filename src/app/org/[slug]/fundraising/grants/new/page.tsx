...
export default async function NewGrantPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="px-4 pt-2 pb-6">
      <div className="mb-4">
        <Link href={`/org/${slug}/fundraising/grants`} className="-my-2 inline-flex min-h-[44px] items-center py-2 pr-3 text-[13px] font-bold text-muted">
          &larr; Grants
        </Link>
      </div>
      <h1 className="mb-1 text-[20px] font-extrabold text-ink">Track a grant</h1>
