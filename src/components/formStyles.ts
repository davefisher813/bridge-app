...
export const inputClass =
  "w-full rounded-[10px] border-0 bg-paper px-3 py-2.5 text-[15px] text-ink placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-accent";
...
export const inputErrorClass =
  "w-full rounded-[10px] border-0 bg-paper px-3 py-2.5 text-[15px] text-ink placeholder:text-muted ring-2 ring-danger focus:outline-none focus:ring-2 focus:ring-danger";

export const labelClass = "mb-1.5 block text-[12px] font-bold text-muted";

export const errorClass = "mt-1 text-[12.5px] font-semibold text-danger";
...
export const submitClass =
  "mt-1 rounded-[8px] bg-solid-accent py-3 text-center text-[15px] font-bold text-solid-accent-on disabled:opacity-60";

// The same button at the size the inline sub-forms (contact, visit,
// communication) use.
export const submitSmallClass =
  "rounded-[8px] bg-solid-accent py-2.5 text-center text-[14.5px] font-bold text-solid-accent-on disabled:opacity-60";
