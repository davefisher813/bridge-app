  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <div>
        ...
        {err("bands") && <p className="mb-2 text-[12.5px] font-semibold text-danger">{err("bands")}</p>}
            ...
            return (
              <div key={letter}>
                <div className="flex items-center gap-2">
                  <span className="flex h-[38px] w-[38px] flex-shrink-0 items-center justify-center rounded-[9px] bg-tint-contact text-[17px] font-black text-tint-contact-on">
                    {letter}
                  </span>
                  <input
                  ...
                  />
                  <span className="text-[14.5px] font-bold text-muted">to</span>
                  <input
                    className={`${fieldClass(rowError)} text-center tabular-nums`}
                    name={`max_${letter}`}
                    inputMode="decimal"
      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <label className="flex items-start gap-3 rounded-[10px] bg-paper px-3 py-2.5">
            ...
            />
            <span className="min-w-0">
              <span className="block text-[14.5px] font-bold text-ink">The weighting only affects class rank, not the GPA</span>
              <span className="mt-0.5 block text-[12.5px] leading-tight text-muted">If this is true, the bonus does not apply at all.</span>
            </span>
          </label>
        </div>
      </div>
